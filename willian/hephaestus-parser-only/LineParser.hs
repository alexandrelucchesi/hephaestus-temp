...
happyReduction_2 (HappyTerminal (TokenText happy_var_1))
	 =  HappyAbsSyn4
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenCommentBegin -> cont 5;
	TokenCommentEnd -> cont 6;
	TokenPlasmaCutter -> cont 7;
	TokenText happy_dollar_dollar -> cont 8;
	_ -> happyError' (tk:tks)
	}
...
parseFunction :: String -> FuncDecls
